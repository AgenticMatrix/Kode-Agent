...
export class SessionManager {
  ...
  updateUsage(usage: Partial<TokenUsageSummary>): void {
    ...
    if (usage.cacheCreationInputTokens) session.tokenUsage.cacheCreationInputTokens += usage.cacheCreationInputTokens;
    if (usage.cacheReadInputTokens) session.tokenUsage.cacheReadInputTokens += usage.cacheReadInputTokens;
