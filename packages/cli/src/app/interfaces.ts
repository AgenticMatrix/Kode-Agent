import type { MouseTrackingMode, ScrollBoxHandle } from '@coder/tui'
import type { MutableRefObject, ReactNode, RefObject, SetStateAction } from 'react'

import type { PasteEvent } from '../components/textInput.js'
import type { IGatewayClient } from '../gateway/client.js'
import type { ImageAttachResponse, SessionCloseResponse } from '../gateway/types.js'
...
export interface UiState {
  ...
  sid: null | string
  /** Whether the slash command popup is open */
  slashCommandOpen: boolean
  /** The text after "/" used to filter commands */
  slashCommandFilter: string
  /** The currently highlighted command index in the popup */
