...
import { Box, NoSelect, ScrollBox, type ScrollBoxHandle, Text, useInput, useStdout } from '@coder/tui'
...
import type { DelegationPauseResponse, DelegationStatusResponse, SubagentInterruptResponse } from '../gateway/types.js'
