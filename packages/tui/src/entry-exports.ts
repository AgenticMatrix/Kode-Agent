...
export { default as ScrollBox, type ScrollBoxHandle, type ScrollBoxProps } from './ink/components/ScrollBox.js'
...
export type { FrameEvent } from './ink/frame.js'
export { InputEvent, type Key } from './ink/events/input-event.js'
