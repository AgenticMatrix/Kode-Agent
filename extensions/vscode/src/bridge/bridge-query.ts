  ...
  events.push(
    ev('message.complete', {
      ...
      usage: {
        ...
        cache: state.usage.cacheCreationInputTokens + state.usage.cacheReadInputTokens,
        total: state.usage.inputTokens + state.usage.outputTokens + state.usage.cacheCreationInputTokens + state.usage.cacheReadInputTokens,
